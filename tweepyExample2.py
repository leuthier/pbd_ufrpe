...
def buscarTweets(query, quantidade):
    ...
    for i in tweet:
        ...
        texto_correto = texto_tweet.encode(sys.stdout.encoding, errors='replace')
        nome_correto = nome_usuario.encode(sys.stdout.encoding, errors='replace')
        screen_name_correto = screen_name_usuario.encode(sys.stdout.encoding, errors='replace')
        lugar_correto = lugar_usuario.encode(sys.stdout.encoding, errors='replace')
